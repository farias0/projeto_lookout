...
public partial class BootsSlot : TextureButton
{
	...
	{
		if (item != null && !item.IsBootsItem)
			throw new InvalidOperationException("Only boots items can be set in the boots slot.");
